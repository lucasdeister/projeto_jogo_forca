...
function ordenarRanking(linhaCompleta, linhaCompleta2){
    ...
    if(valorSubstituido > vet[1]){
        document.getElementById('posicao2').innerHTML = '2' + linhaCompleta;
        if(valorSubstituido2 > vet[2]){
            document.getElementById('posicao3').innerHTML = '3' + linhaCompleta2;
        }
    }
    else{
        if(valorSubstituido > vet[2]){
            document.getElementById('posicao3').innerHTML = '3' + linhaCompleta;
        }
    }
}
...
function obterCategoriaEscolhida(){
    ...
    let categoriaEscolhida = document.getElementById('cmbTemas').value;
...
function verificarAtualizacaoRanking(){
    ...
    if(qtdPontos > vetPontosRanking[0]){
        ...
        vet[1] = document.getElementById('posicao1').innerHTML;
        vet[2] = document.getElementById('posicao2').innerHTML;
    }
    else{
        if(qtdPontos > vetPontosRanking[1]){
            rankAserAtualizado = 2;
            vet[0] = rankAserAtualizado;
            vet[1] = document.getElementById('posicao2').innerHTML;
            vet[2] = document.getElementById('posicao3').innerHTML;
    }
    else{
...
function obterValoresRanking(){
    ...
    let primeiroLugar = document.getElementById("posicao1").innerHTML;
    let segundoLugar = document.getElementById("posicao2").innerHTML;
    let terceiroLugar = document.getElementById("posicao3").innerHTML;
